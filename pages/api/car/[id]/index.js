  ...
  const newCar = new CarData({
    ...
    moreInformations: {
      maintenanceHistory: {
        maintenance1: {
          description:
            req.body.car.moreInformations.maintenanceHistory.maintenance1
              .description,
          date: req.body.car.moreInformations.maintenanceHistory.maintenance1
            .date,
          location:
            req.body.car.moreInformations.maintenanceHistory.maintenance1
              .location,
        ...
        maintenance2: {
          description:
            req.body.car.moreInformations.maintenanceHistory.maintenance2
              .description,
          date: req.body.car.moreInformations.maintenanceHistory.maintenance2
            .date,
          location:
            req.body.car.moreInformations.maintenanceHistory.maintenance2
              .location,
      ...
      performance: {
        ...
        fuelEfficiency:
          req.body.car.moreInformations.performance.fuelEfficiency,
      },
    },
  });
  const car = await newCar.save();
  await db.disconnect();
  res.send({ message: '500 added successfully!', car });
};
